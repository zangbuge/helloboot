...
public class UserInfo implements org.apache.thrift.TBase<UserInfo, UserInfo._Fields>, java.io.Serializable, Cloneable, Comparable<UserInfo> {
  ...
  private static final org.apache.thrift.protocol.TField WORK_YEAR_FIELD_DESC = new org.apache.thrift.protocol.TField("workYear", org.apache.thrift.protocol.TType.BYTE, (short)6);
  ...
  private static final int __WORKYEAR_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.SEX};
  ...
  public UserInfo setWorkYear(byte workYear) {
    this.workYear = workYear;
    setWorkYearIsSet(true);
    return this;
  }
  ...
  public void unsetWorkYear() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __WORKYEAR_ISSET_ID);
  }

  /** Returns true if field workYear is set (has been assigned a value) and false otherwise */
  public boolean isSetWorkYear() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __WORKYEAR_ISSET_ID);
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + (int) (workYear);
  ...
  private static class UserInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<UserInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, UserInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // WORK_YEAR
            if (schemeField.type == org.apache.thrift.protocol.TType.BYTE) {
              struct.workYear = iprot.readByte();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UserInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeByte(struct.workYear);
      oprot.writeFieldEnd();
